...
namespace ST
{
    ...
    */
    ST_API std::string formattedStringFromLocaltime (
        const std::string& format = "%Y-%m-%d_%H-%M-%S" /* e.g. 2017-02-15_11-45-38 */);
    ...
    */
    ...
    /** @brief Sets the internal GUI-based debugging verbosity. 1 is default, -1 will
     * disable the HUD entirely. */
    ST_API bool setVisualLoggingVerbosity (int verbosity = 1);

    /** @brief Sets the internal console-based debugging verbosity. 0 is default, 1 will
     * likely slow your application. */
