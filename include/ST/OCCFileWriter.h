...
struct ST_API OCCFileWriter
{
    ...
    */
    ...
    /** @brief Write the provided pose to the OCC file.
        ...
        @param frameOfReference The frame of reference of the provided pose.
        @see TrackerPoseFrameOfReference, BridgeEngine::getTimestampNow, BridgeEngine::TrackerPrediction
    */
    void writeCameraPose(const Matrix4& cameraPose, double timestamp, TrackerPoseFrameOfReference frameOfReference);
